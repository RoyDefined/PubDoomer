...
/// <summary>
/// Represents a converter that returns a boolean indicating if the given item is not the last item in a collection.
/// <br/> The item must be a reference type that is able to compare by reference against other items in the collection.
/// </summary>
public sealed class ItemNotLastInCollectionMultiValueConverter : IMultiValueConverter
{
