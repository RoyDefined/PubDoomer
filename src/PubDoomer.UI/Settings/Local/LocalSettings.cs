...
public partial class LocalSettings : ObservableObject
{
    ...
    public LocalSettings()
    {
        ...
        Configurations = new()
        {
            ...
            [CompileTaskStatics.GdccCcCompilerExecutableFilePathKey] = "Path/To/GDCC-CC.exe",
            [CompileTaskStatics.GdccMakeLibCompilerExecutableFilePathKey] = "Path/To/GDCC-MakeLib.exe",
            [CompileTaskStatics.GdccLdCompilerExecutableFilePathKey] = "Path/To/GDCC-LD.exe",
